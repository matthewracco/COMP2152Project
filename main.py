...
# Magic Shop interaction
    def shop_interaction(can_buy, can_sell, items, section_name):
        while True:
            ...
            if choice == "1" and can_buy:
                ...
                try:
                    ...
                    if 0 <= item_index < len(items):
                        print(f"You bought the {items[item_index]}!")
                    else:
                        print("Invalid item number.")
                except ValueError:
                    print("Invalid input.")
            elif choice == "2" and can_sell:
                print("You sold a potion!")
            elif choice == "3":
                break
            else:
                print("Invalid option or action not available.")

    def main():
        while True:
            print("\nWelcome to the Magic Shop!")
            print("Where do you want to go?")
            print("1. Artifacts Section")
            print("2. Potions Section")
            print("3. Exit")

            choice = input("Enter your choice (1, 2, or 3): ")

            if choice == "1":
                can_buy, can_sell, items = functions.magic_shop("Artifacts")
                shop_interaction(can_buy, can_sell, items, "Artifacts")
            elif choice == "2":
                can_buy, can_sell, items = functions.magic_shop("Potions")
                shop_interaction(can_buy, can_sell, items, "Potions")
            elif choice == "3":
                print("Thanks for visiting the Magic Shop!")
                break
            else:
